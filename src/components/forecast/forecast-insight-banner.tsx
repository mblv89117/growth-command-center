  ...
  return (
    <div className="mb-4 rounded-xl border border-green-500/30 bg-green-500/5 p-4">
      <div className="mb-3 flex items-start gap-3">
        ...
        <div>
          <p className="font-medium">Import landed — continue from this forecast</p>
          <p className="text-sm text-muted-foreground">
            This 13-week view uses imported SOURCE-DERIVED numbers. Next: the executive dashboard
            and value-creation opportunities from those same numbers. This banner does not invent
            cash, forecast, or KPI values.
          </p>
        </div>
      </div>
