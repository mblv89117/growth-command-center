...
export const ALERTS: Alert[] = [
  ...
  { id: "alert-7", title: "Debt Coverage Concern", description: "Debt service coverage ratio is projected at 1.2x in July.", severity: "critical", recommendedAction: "Prepare lender communication. Model impact of delayed capex on coverage ratio.", affectedMetric: "Debt Service Coverage", riskWindow: "Jul 2025", owner: "Sarah Chen", isRead: false, createdAt: "2025-05-20T09:00:00Z" },
];
