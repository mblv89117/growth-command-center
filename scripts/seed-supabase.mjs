...
async function seed() {
  ...
  const kpis = [
    ["revenue_growth", "Revenue Growth", 12.4, "percent", 2.1, "vs last month", null], // Do not invent leftover Revenue Growth target = 10.
    ["gross_margin", "Gross Margin", 35.9, "percent", -1.2, "vs last month", null], // Do not invent leftover Gross Margin target = 32.
    ["net_margin", "Net Margin", 13.0, "percent", 0.8, "vs last month", null], // Do not invent leftover Net Margin target = 12.
    ["runway", "Runway", 3.4, "number", -0.3, "months", null], // Do not invent leftover Runway target = 6.
