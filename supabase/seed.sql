...
INSERT INTO kpis (organization_id, kpi_key, name, value, unit, change, change_label, target) VALUES
  -- Do not invent leftover Apex demo seed.sql KPI targets 10/32/12/45/40/35/30/28/24/6. Owner-set targets remain SOURCE-DERIVED.
...
INSERT INTO alerts (organization_id, alert_key, title, description, severity, recommended_action, affected_metric, risk_window, owner, is_read) VALUES
  ...
  -- Do not invent leftover Apex demo 1.5x DSCR covenant threshold. Owner-set covenants remain SOURCE-DERIVED.
  ('org-apex', 'debt-coverage', 'Debt Coverage Concern', 'Debt service coverage ratio is projected at 1.2x in July.', 'critical', 'Prepare lender communication. Model impact of delayed capex on coverage ratio.', 'Debt Service Coverage', 'Jul 2025', 'Sarah Chen', false)
